...
export const SERVICES = [
  { icon: "Wrench", title: "Техническое обслуживание кондиционеров", desc: "Плановое ТО кондиционеров по регламенту производителя. Продляем срок службы техники.", price: "от 2 000 ₽" },
