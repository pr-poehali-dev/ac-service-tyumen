...
export const SERVICES = [
  ...
  { icon: "Hammer", title: "Монтаж/Установка кондиционеров и систем вентиляции", desc: "Профессиональный монтаж кондиционеров и систем вентиляции под ключ любой сложности.", price: "от 2 000 ₽" },
